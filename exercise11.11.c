...
// as its argument and that updates the strucutre to the following day.
// See Program 9.4 for the definition of a date structure.
...
int main(int argc, char const *argv[])
{
  ...
  struct date *thisDayPtr = &thisDay;

  printf("Enter today's date (mm dd yyyy): ");
  scanf("%i%i%i", &thisDay.month, &thisDay.day, &thisDay.year);
  nextDay = dateUpdate(thisDayPtr);
